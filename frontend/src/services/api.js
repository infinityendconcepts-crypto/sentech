...
export const applicationsAPI = {
  ...
  lock: (id) => api.put(`/applications/${id}/lock`),
  unlock: (id) => api.put(`/applications/${id}/unlock`),
  batchUnlock: (ids) => api.post('/applications/batch-unlock', { application_ids: ids }),
...
export const trainingApplicationsAPI = {
  ...
  lock: (id) => api.put(`/training-applications/${id}/lock`),
  unlock: (id) => api.put(`/training-applications/${id}/unlock`),
  batchUnlock: (ids) => api.post('/training-applications/batch-unlock', { application_ids: ids }),
